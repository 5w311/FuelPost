...
function planAdaptive(poly, routeMiles, stops, maxRange, startBurned, tiers = [8, 15, 30], arrivalReserve = 0, targetLeg = 0) {
  let last = null;
...
function planBeyondGap(poly, routeMiles, stops, maxRange, gap, detourMax, arrivalReserve = 0, targetLeg = 0) {
  ...
  const rest = planFuel(routeMiles - anchor.mile, shifted, maxRange, 0, arrivalReserve, targetLeg);
  const plan = [

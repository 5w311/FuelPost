...
/* ---- Gallons, and what a stop is worth (v1.51.0) ----
   ...
   figure and is deliberately below the 8.9 currently measured: under-stating
   mpg under-states the gallons a leg will pump, so a stop this app calls a
   credit is one the pump agrees with. Over-stating it would do the opposite.
